...
suspend fun PointerInputScope.detectTransformGestures(
    ...
    awaitEachGesture {
        ...
        if (release != null && release.changes.isNotEmpty()) {
            ...
            // Fired synchronously in the release frame so the overlay toggles
            // with zero perceived latency; a quick second release upgrades to
            // a double tap without revoking this tap.
            when (tapClassifier.classifyRelease(
                ...
                GestureTapClassifier.Decision.TAP -> onTap(up.position)
                GestureTapClassifier.Decision.DOUBLE_TAP -> onDoubleTap(up.position)
