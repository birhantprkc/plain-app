...
expected_mutations="createChatChannel updateChatChannel deleteChatChannel leaveChatChannel addChatChannelMember removeChatChannelMember acceptChatChannelInvite declineChatChannelInvite deleteNotifications replyNotification unarchiveConversation sendSms archiveConversation trashSms restoreSms deleteSms sendMms createTag updateTag deleteTag addToTags updateTagRelations removeFromTags clearAppLogs pairDevice cancelPairing respondToPairing startScreenMirror requestScreenMirrorAudio stopScreenMirror updateScreenMirrorQuality sendScreenMirrorControl requestScreenMirrorKeyFrame deleteChunks mergeChunks mergeAppFileChunks deleteFiles createDir renameFile writeTextFile copyFile moveFile addFavoriteFolder removeFavoriteFolder setFavoriteFolderAlias syncFeeds updateFeed createFeed importFeeds exportFeeds deleteFeed syncFeedContent deleteFeedEntries deletePeer unpairPeer sendChatItem deleteChatItem deleteChatItems retryChatItem playAudio updateAudioPlayMode clearAudioQueue removeAudioFromQueue addAudiosToQueue reorderAudioQueue createAudioPlaylist renameAudioPlaylist deleteAudioPlaylist addAudioPlaylistItems removeAudioPlaylistItem playAudioPlaylist playAllAudios enableImageSearch disableImageSearch cancelImageModelDownload startImageIndex cancelImageIndex call deleteCalls saveNote saveFeedEntriesToNotes trashNotes restoreNotes deleteNotes exportNotes deleteMediaItems trashMediaItems restoreMediaItems moveMediaItems setTempValue relaunchApp openAccessibilitySettings openWebSettings updateDeviceName deleteContacts updateContact createContact createContactGroup updateContactGroup deleteContactGroup startDiscovery stopDiscovery startPomodoro pausePomodoro stopPomodoro deleteDataStoreEntry saveImageEditorProject deleteImageEditorProject broadcastImageEditorUpdate uninstallPackages installPackage createDbTableRow deleteDbTableRows setClipboard deleteClipboard addBookmarks updateBookmark deleteBookmarks recordBookmarkClick createBookmarkGroup updateBookmarkGroup deleteBookmarkGroup"
