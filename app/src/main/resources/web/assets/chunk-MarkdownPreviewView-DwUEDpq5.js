import{i as e}from"./chunk-rolldown-runtime-aKtaBQYM.js";import{_ as t,b as n,g as r,k as i,mt as a}from"./chunk-runtime-core.esm-bundler-DrnlzXx3.js";import{t as o}from"./chunk-_plugin-vue_export-helper-BDNMzG2s.js";import{t as s}from"./chunk-katex-CcpNJcXo.js";import{a as c,c as l,i as u,l as d,n as f,o as p,r as m,s as h,t as g,u as _}from"./chunk-markdown-it-task-lists-B2hGXJfn.js";var v=e(d(),1),y=e(l(),1),b=e(h(),1),x=e(p(),1),S=e(c(),1),C=e(u(),1),w=e(m(),1),T=e(f(),1),E=e(g(),1),D={class:`md-preview-page`},O={class:`md-preview-main`},k=[`innerHTML`],A=`# Heading 1
...
`,j=o(i({__name:`MarkdownPreviewView`,setup(e){let i=new _({html:!0,xhtmlOut:!0,breaks:!0,linkify:!0,typographer:!0}).use(v.default).use(y.default).use(b.default).use(x.default).use(S.default).use(C.default).use(w.default).use(T.default,{engine:s,delimiters:`dollars`,katexOptions:{output:`html`}}).use(E.default,{enabled:!0}),o=r(()=>i.render(A));return(e,r)=>(a(),n(`div`,D,[r[0]||=t(`header`,{class:`md-preview-header`},[t(`h1`,null,`Markdown Preview`)],-1),t(`main`,O,[t(`div`,{class:`md-container`,innerHTML:o.value},null,8,k)])]))}}),[[`__scopeId`,`data-v-8d6dfba0`]]);export{j as default};