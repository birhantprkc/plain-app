...
</v-dropdown>`,ce=c({__name:`UxOverlays`,setup(t){let n=e(!1),r=e(!1),c=e(!1);return(e,t)=>{let f=S,m=C,h=k,v=g,y=j,b=_;return l(),s(`section`,ae,[t[19]||=o(`h2`,null,`Overlays`,-1),i(G,{code:oe},{default:u(()=>[i(f,{onClick:t[0]||=e=>n.value=!0},{default:u(()=>[...t[13]||=[a(`Open Modal`,-1)]]),_:1}),n.value?(l(),d(h,{key:0,onClose:t[3]||=e=>n.value=!1},{headline:u(()=>[...t[14]||=[a(`Modal Title`,-1)]]),content:u(()=>[...t[15]||=[o(`p`,null,`This is the modal content area. You can put any content here.`,-1)]]),actions:u(()=>[i(m,{onClick:t[1]||=e=>n.value=!1},{default:u(()=>[...t[16]||=[a(`Cancel`,-1)]]),_:1}),i(f,{onClick:t[2]||=e=>n.value=!1},{default:u(()=>[...t[17]||=[a(`Confirm`,-1)]]),_:1})]),_:1})):p(``,!0)]),_:1}),t[20]||=o(`h3`,null,`<v-dropdown> + .dropdown-item`,-1),i(G,{code:se},{default:u(()=>[i(v,{modelValue:r.value,"onUpdate:modelValue":t[9]||=e=>r.value=e},{trigger:u(()=>[i(m,{onClick:t[4]||=e=>r.value=!r.value},{default:u(()=>[...t[18]||=[a(`Open Dropdown`,-1)]]),_:1})]),default:u(()=>[o(`div`,{class:`dropdown-item`,onClick:t[5]||=e=>r.value=!1},`Action One`),o(`div`,{class:`dropdown-item`,onClick:t[6]||=e=>r.value=!1},`Action Two`),o(`div`,{class:`dropdown-item selected`,onClick:t[7]||=e=>r.value=!1},`Selected Item`),o(`div`,{class:`dropdown-item danger`,onClick:t[8]||=e=>r.value=!1},`Danger Item`)]),_:1},8,[`modelValue`])]),_:1}),i(G,{code:`<!-- Dropdown with icon button trigger -->
...
</v-dropdown>`},{default:u(()=>[i(v,{modelValue:c.value,"onUpdate:modelValue":t[12]||=e=>c.value=e},{trigger:u(()=>[i(b,null,{default:u(()=>[i(y)]),_:1})]),default:u(()=>[o(`div`,{class:`dropdown-item`,onClick:t[10]||=e=>c.value=!1},`Edit`),o(`div`,{class:`dropdown-item danger`,onClick:t[11]||=e=>c.value=!1},`Delete`)]),_:1},8,[`modelValue`])]),_:1})])}}}),le=[`tabindex`],ue={key:0,class:`v-input-chip__icon`},de={class:`v-input-chip__label`},fe=[`disabled`,`aria-label`],pe=y(c({__name:`VInputChip`,props:{label:{default:``},selected:{type:Boolean,default:!1},disabled:{type:Boolean,default:!1},removeOnly:{type:Boolean,default:!1},ariaLabelRemove:{default:``}},emits:[`remove`,`click`],setup(e,{emit:t}){let i=e,a=t;function c(){!i.disabled&&!i.removeOnly&&a(`click`)}function u(){i.disabled||a(`remove`)}function d(e){(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),c())}return(t,i)=>(l(),s(`div`,{class:r([`v-input-chip`,{"v-input-chip--selected":e.selected,"v-input-chip--disabled":e.disabled,"v-input-chip--remove-only":e.removeOnly}]),tabindex:e.disabled?-1:0,onClick:c,onKeydown:d},[t.$slots.default?(l(),s(`span`,ue,[f(t.$slots,`default`,{},void 0,!0)])):p(``,!0),o(`span`,de,n(e.label),1),o(`button`,{class:`v-input-chip__remove`,type:`button`,disabled:e.disabled,"aria-label":e.ariaLabelRemove||`Remove`,onClick:h(u,[`stop`])},[...i[0]||=[o(`svg`,{viewBox:`0 0 24 24`,width:`18`,height:`18`},[o(`path`,{d:`M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z`})],-1)]],8,fe)],42,le))}}),[[`__scopeId`,`data-v-aa119b53`]]),me={class:`ux-section`},he={class:`top-app-bar`,style:{width:`100%`}},ge={class:`actions`},_e=c({__name:`UxDataDisplay`,setup(t){let n=e(`all`);return(e,t)=>{let r=F,a=P,c=pe,d=A,f=_,p=T,m=j;return l(),s(`section`,me,[t[6]||=o(`h2`,null,`Chips & Data Display`,-1),t[7]||=o(`h3`,null,`<v-filter-chip> + <v-chip-set>`,-1),i(G,{code:`<v-chip-set>
